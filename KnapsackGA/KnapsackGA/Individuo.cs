...
namespace KnapsackGA
{
    ...
    //
    {
        ...
        public Individuo(double _capacidade, int _N)
        {
        ...
        {
           Individuo clone = new Individuo(_PesoTotal, N);
           for (int i = 1; i <= N; i++)
            {
        ...
        public Individuo geraAleatorio(double _PesoTotal, int _N, Random _rand){
            Individuo feto = new Individuo(_PesoTotal, _N);
            for (int i=1; i<=_N; i++){
